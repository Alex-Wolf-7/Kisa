...
type GameEvents struct {
	...
	SmartCastWithIndicator1         Binding `json:"evtSmartCastWithIndicatorSpell1"`
	...
	SmartCastWithIndicator2         Binding `json:"evtSmartCastWithIndicatorSpell2"`
	...
	SmartCastWithIndicator3         Binding `json:"evtSmartCastWithIndicatorSpell3"`
